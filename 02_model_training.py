...
def run_model_training():
    """
    Trains a XGBoost model to predict expected energy use and calculates efficiency deviations.

    Reads in machine learning ready data from processed/ folder. Defines the features to look for in this data set. 
    Then a XGBoost machine learning object is created to learn from a training subset. It then applies what it learned
    to a test data subset (the data NOT used for training). Calculates EUI deviation and saves this to processed/ folder.
    """
